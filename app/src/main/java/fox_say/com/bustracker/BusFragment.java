...
public class BusFragment extends Fragment implements Session.RouteListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mapView = (MapView) view.findViewById(R.id.mapViewTransport);
    ...
    public void onMasstransitRoutesError(@NonNull Error error) {
        Toast.makeText(this.getActivity(), "onMasstransitRoutesError", Toast.LENGTH_SHORT).show();
    }
